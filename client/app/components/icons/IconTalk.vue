<!--
  Ported from resources/views/svgs/navigation/talk-icon.blade.php (design.md
  §2 Icons: inline SVG components under components/icons/).
-->
<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="27.5" height="23.325" viewBox="0 0 27.5 23.325" aria-hidden="true">
