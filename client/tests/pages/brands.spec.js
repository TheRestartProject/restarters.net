...
describe('pages/brands', () => {
  ...
  it('passes brand_name as the display key and a single required text form field', () => {
    ...
    // allowCreate/allowDelete aren't passed explicitly - like the legacy
    // BrandsPage.vue, this page relies on AdminCrudTable's own defaults
    // (both true), covered by that component's own generic suite.
  })
