...
(SELECT
d.id_ords AS items,
COALESCE(ANY_VALUE(a.fault_type_id),(SELECT o1.fault_type_id FROM devices_faults_tablets_ora_opinions o1 WHERE o1.id_ords = o.id_ords GROUP BY o1.fault_type_id ORDER BY COUNT(o1.fault_type_id) DESC LIMIT 1)) AS winning_opinion,
...
d.id_ords AS items,
ANY_VALUE(a.fault_type_id) AS adjudicated_opinion_id,
ROUND((SELECT COUNT(o2.fault_type_id) as top_crowd_opinion_count FROM devices_faults_tablets_ora_opinions o2 WHERE o2.id_ords = o.id_ords GROUP BY o2.fault_type_id ORDER BY top_crowd_opinion_count DESC LIMIT 1) /
(SELECT COUNT(o2.fault_type_id) as all_votes FROM devices_faults_tablets_ora_opinions o2 WHERE o2.id_ords = o.id_ords) * 100) AS top_crowd_opinion_percentage,
COUNT(o.fault_type_id) AS all_crowd_opinions_count
FROM `devices_tabicat_ora` d
LEFT OUTER JOIN devices_faults_tablets_ora_opinions o ON o.id_ords = d.id_ords
LEFT OUTER JOIN devices_faults_tablets_ora_adjudicated a ON a.id_ords = d.id_ords
...
d.id_ords,
ANY_VALUE(a.fault_type_id) AS adjudicated_opinion_id,
(SELECT o1.fault_type_id FROM devices_faults_tablets_ora_opinions o1 WHERE o1.id_ords = o.id_ords GROUP BY o1.fault_type_id ORDER BY COUNT(o1.fault_type_id) DESC LIMIT 1) AS top_crowd_opinion,
ROUND((SELECT COUNT(o2.fault_type_id) as top_crowd_opinion_count FROM devices_faults_tablets_ora_opinions o2 WHERE o2.id_ords = o.id_ords GROUP BY o2.fault_type_id ORDER BY top_crowd_opinion_count DESC LIMIT 1) /
(SELECT COUNT(o2.fault_type_id) as all_votes FROM devices_faults_tablets_ora_opinions o2 WHERE o2.id_ords = o.id_ords) * 100) AS top_crowd_opinion_percentage,
COUNT(o.fault_type_id) AS all_crowd_opinions_count,
...
LEFT OUTER JOIN devices_faults_tablets_ora_opinions o ON o.id_ords = d.id_ords
LEFT OUTER JOIN devices_faults_tablets_ora_adjudicated a ON a.id_ords = d.id_ords
LEFT OUTER JOIN fault_types_tablets ft ON ft.id = o.fault_type_id
GROUP BY d.id_ords
HAVING
(all_crowd_opinions_count = 3 AND top_crowd_opinion_percentage < 60)
AND adjudicated_opinion_id IS NULL
");
    ...
    /**
     * Write the winning opinions to `devices_tabicat_ora`.`fault_type`.
     *
     * @return mixed
     */
