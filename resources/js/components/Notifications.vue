<template>
  <div class="badge-group">
    <a :href="url" id="badge-talk-notifications" :class="{
      'badge': true,
      'badge-pill': true,
      'badge-info' : true,
      'badge-left': true,
      ...
      <span class="chat-count">{{ discourseNotifications }}</span>
    </a>
    <div>
      <button id="notifications-badge" :class="{
        ...
        <svg width="14" height="20" viewBox="0 0 11 15" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
        ...
        <span class="count">{{ restartersNotifications }}</span>
      </button>
    </div>
  </div>
</template>
