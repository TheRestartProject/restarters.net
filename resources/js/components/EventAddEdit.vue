<template>
  <div>
    <div class="eae-layout">
      ...
      <div class="event-approve" v-if="!creating && canApprove">
        <b-form-group>
      ...
      <div class="event-result text-right">
        <p v-if="edited" class="mt-2 text-primary font-weight-bold" v-html="'<div>' + __('events.edit_succeeded') + '</div>'" />
