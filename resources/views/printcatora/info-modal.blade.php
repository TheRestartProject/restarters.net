<!-- Modal -->
<div class="modal fade" id="printcatoraInfoModal" printndex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="printcatoraModalLabel">About PrintCat</h5>
            ...
            <div class="modal-body">
                <p>
                    PrintCat is a web app to <strong>collaboratively categorise the type of faults in printers brought to community events</strong> such as Restart Parties and Repair Cafés.
                </p>
                <hr/>
                <p>
