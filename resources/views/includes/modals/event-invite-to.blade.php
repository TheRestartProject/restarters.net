    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header d-flex justify-content-between">
          ...
          <a data-toggle="collapse" href="#eventShareableLink" role="button" aria-expanded="false" aria-controls="eventShareableLink" class="align-items-center text-dark"><svg width="13" height="13" viewBox="0 0 580 680" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
        ...
        <div class="modal-body">
          <form action="/party/invite" method="post" onkeypress="return event.keyCode != 13;">
            ...
            <div class="collapse" id="eventShareableLink">
              <div id="invite_div" class="form-group">
