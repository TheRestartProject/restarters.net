            ...
            <div id="collapseGroupCO2" class="collapse" aria-labelledby="headingGroupCO2" data-parent="#accordionGroup">
              <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control field" id="group_co2_stats_embed" value='<iframe src="{{{ env('APP_URL') }}}/outbound/info/group/{{{ $group->idgroups }}}/leaf" frameborder="0" width="700" height="850"></iframe>'>
                  </div>

                  <div class="embed-responsive embed-responsive-21by9">
                    <iframe src="{{{ env('APP_URL') }}}/outbound/info/group/{{{ $group->idgroups }}}/leaf" frameborder="0" width="700" height="850" class="form-control embed-responsive-item"></iframe>
                  </div>
