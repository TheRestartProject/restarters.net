            ...
            <div id="collapseGroupHeadline" class="collapse" aria-labelledby="headingGroupHeadline" data-parent="#accordionGroup">
              <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control field" id="group_headline_stats_embed" value='<iframe src="{{{ env('APP_URL') }}}/group/stats/1" frameborder="0" width="100%" height="115"></iframe>'>
                  </div>
            ...
            <div id="collapseGroupCO2" class="collapse show" aria-labelledby="headingGroupCO2" data-parent="#accordionGroup">
              <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control field" id="group_co2_stats_embed" value='<iframe src="{{{ env('APP_URL') }}}/outbound/info/group/1" frameborder="0" width="700" height="850"></iframe>'>
                  </div>
