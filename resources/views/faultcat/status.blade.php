    ...
    <div class="container mt-1 mt-sm-4">
        <div class="row row-compressed">
            ...
            https://commons.wikimedia.org/wiki/Category:SVG_emoji_smilies
                ...
                <a href="/faultcat">
                    <img id="faultcat" src="{{ asset('/images/faultcat/100-cat-face-with-wry-smile.svg.png') }}" alt="Go to FaultCat" width="48" height="48" />
                </a>
            </div>
        </div>
        @if (isset($status))
            <div class="row problem panel p-2 mb-4 mx-1 mx-sm-0 justify-content-center">
                <div class="col">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col">
                            <p class="badge-pill badge-light"><span>with 5 opinions</span></p>
                            <p>
                                @php( print($status['total_opinions_5'][0]->total))
                            </p>
                        </div>
                        <div class="col">
                            <p class="badge-pill badge-light"><span>with 4 opinions</span></p>
                            <p>
                                @php( print($status['total_opinions_4'][0]->total))
                            </p>
                        </div>
                        <div class="col">
