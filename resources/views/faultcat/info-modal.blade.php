<!-- Modal -->
<div class="modal fade" id="faultcatInfoModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">About FaultCat</h5>
            ...
            <div class="modal-body">
                <p>
                    FaultCat is a web app to help <strong>collaboratively categorise the type of faults in computers brought to community events</strong> such as Restart Parties and Repair Cafes.
                </p>
                <hr/>
                <p>
