...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1>Edit Party
                <small>
                    <button type="submit" id=btn_save onClick="onClickFun(this)" class="btn btn-primary btn-sm"><i class="fa fa-floppy-o"></i> save</button>

                    <a href="/party/edit/<?php echo $party->id; ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> edit details</a>

                    <?php $home_url = (FixometerHelper::hasRole($user, 'Administrator') ? '/admin' : '/host'); ?>
            ...
            <div class="row party " >
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 text-right">
                      <button class="btn btn-default" type="button" data-toggle="modal" data-target="#esw"><i class="fa fa-share"></i>Share </button>
                    </div>
                </div>
            </div>
            <!-- devices -->
...
<th> <i class="fa fa-question-circle" data-toggle="popover" title="Spare parts required?" data-content="Whether a spare part (or parts) would be needed to complete the repair successfully.  Ticking this box does not necessarily indicate that the needed part(s) were available at the party, only that there is a need for an additional part(s).   Please be sure to indicate in the comments field what part is needed (if known) and whether it is available at the party."></i>Spare Parts?</th>
                    ...
                    <tbody>
                        ...
                        <tr class="rs-<?php echo $devices[$i-1]->repair_status; ?>">
                            ...
                            <td>
                                ...
                                <div class="form-group
                                    ...
                                    <input type="number" step="00.01" min="0" max="99.99" name="device[<?php echo $i; ?>][estimate]" id="device[<?php echo $i; ?>][estimate]" class="form-control" placeholder="Estimate..." value="<?php echo $devices[$i-1]->estimate; ?>">
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="text" name="device[<?php echo $i; ?>][brand]" id="device[<?php echo $i; ?>][brand]" class="form-control" placeholder="Brand - e.g. Apple, Dyson" value="<?php echo $devices[$i-1]->brand; ?>">
                                </div>

                                <div class="form-group">
                                    <input type="text" name="device[<?php echo $i; ?>][model]" id="device[<?php echo $i; ?>][model]" class="form-control" placeholder="Model - e.g. iPhone 5s, DC50" value="<?php echo $devices[$i-1]->model; ?>">
                                </div>

                                <div class="form-group">
                                    <?php $ageInputType = (FixometerHelper::featureIsEnabled(env('FEATURE__DEVICE_AGE'))) ? "text" : "hidden"; ?>
                                    <input type="<?php echo $ageInputType; ?>" name="device[<?php echo $i; ?>][age]" id="device[<?php echo $i; ?>][age]" class="form-control" placeholder="Age - e.g. 3 years" value="<?php echo $devices[$i-1]->age; ?>">
                                </div>
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input
                                                   ...
                                                   value="3"
                                                   <?php echo ($devices[$i-1]->repair_status == 3 ? 'checked="checked"' : ''); ?>>End of
                                        </label>
                                    </div>
                                </div>
                            </td>
                        ...
                        @php( $start = (!empty($devices) ? count($devices) + 1 : 1) )
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="form-group hide estimate-box">
                                    <small>Please input an estimate weight (in kg)</small>
                                    <div class="input-group">
                                        <input type="number" step="00.01" min="0" max="99.99" name="device[<?php echo $i; ?>][estimate]" id="device[<?php echo $i; ?>][estimate]" class="form-control" placeholder="Estimate...">
                                        <span class="input-group-addon">kg</span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                 <div class="form-group">
                                    <input type="text" name="device[<?php echo $i; ?>][brand]" id="device[<?php echo $i; ?>][brand]" class="form-control" placeholder="Brand - e.g. Apple, Dyson">
                                </div>

                                <div class="form-group">
                                    <input type="text" name="device[<?php echo $i; ?>][model]" id="device[<?php echo $i; ?>][model]" class="form-control" placeholder="Model - e.g. iPhone 5s, DC50" >
                                </div>

                                <div class="form-group">
                                    <input type="hidden" name="device[<?php echo $i; ?>][age]" id="device[<?php echo $i; ?>][age]" class="form-control" placeholder="Age - e.g. 3 years" >
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="form-group">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="device[<?php echo $i; ?>][repair_status]" id="device[<?php echo $i; ?>][repair_status_1]" value="1" che
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                ...
                <div class="text-center">
                    <br /><br />
                    <button type="submit" id="btn_save" onClick="onClickFun(this)" class="btn btn-primary btn-lg"><i class="fa fa-floppy-o"></i> Save</button>
