...
<div class="container">
    ...
    <div class="row">
        <div class="container">
            ...
            <!-- Profiles -->
    <?php if(FixometerHelper::hasRole( $user, 'Administrator' )) { ?>
                    ...
                    <form action="/party/create" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if(FixometerHelper::hasRole($user, 'Host') && !FixometerHelper::hasRole($user, 'Root')) {
                                ...
                                @endif
                                <div class="form-group">
                                    <label for="venue">Party Name: </label>
