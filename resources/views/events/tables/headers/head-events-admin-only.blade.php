    ...
    <tr>
      <th class="hightlighted"></th>
        ...
        <th scope="col" class="d-none d-sm-table-cell">
          <button type="button" class="btn btn-skills" data-container="body" data-toggle="popover" data-placement="top" data-content="@lang('events.stat-2')">@include('events.tables.svgs.restarters')</button>
        </th>
