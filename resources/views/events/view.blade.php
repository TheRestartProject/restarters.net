    ...
    <div class="events__header row align-content-top">
      ...
      <div class="col-lg-4">
        <div class="button-group button-group__r">
          @if( Auth::check() )
            ...
            @else
                @if( $event->hasFinished() )
                    <button data-toggle="modal" data-target="#event-share-stats" class="btn btn-primary">@lang('events.share_event_stats')</a>
                @else
                    @if (! Auth::user()->isInGroup($event->theGroup->idgroups))
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          @if( $event->isInProgress() || $event->hasFinished() )
          <h2 id="environmental-impact" class="d-none d-lg-block">@lang('events.environmental_impact')</h2>
          <h2 id="environmental-impact" class="collapse-header"><a class="collapsed" data-toggle="collapse" href="#environmental-impact-section" role="button" aria-expanded="false" aria-controls="environmental-impact-section">@lang('environmental_impact')</a></h2>
          <div id="environmental-impact-section" class="collapse d-lg-block collapse-section">
            <ul class="properties">
              <li>
                <div>
                  <h3>@lang('events.waste_prevented')</h3>
              ...
              <li>
                <div>
                  <h3>@lang('events.co2_prevented')</h3>
              ...
              <li>
                <div>
                  <h3>@lang('events.fixed_devices')</h3>
              ...
              <li>
                <div>
                  <h3>@lang('events.repairable_devices')</h3>
              ...
              <li>
                <div>
                  <h3>@lang('events.end_of_life_devices')</h3>
              ...
              <table class="table table-repair" role="table" id="device-table">
                <thead>
                  <tr>
                    ...
                    <th class="d-none d-md-table-cell">@lang('partials.category')</th>
                    <th class="d-none d-md-table-cell">@lang('partials.brand')</th>
                    <th class="d-none d-md-table-cell">@lang('partials.model')</th>
                    <th class="d-none d-md-table-cell">@lang('partials.age')</th>
                    <th><span class="d-none d-sm-inline">@lang('partials.description_of_problem_solution')</span></th>
                    <th width="65px">@lang('partials.status')</th>
                    <th width="95px">@lang('partials.spare_parts')</th>
                    @if( Auth::check() )
