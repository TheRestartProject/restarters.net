    ...
    <div class="events__header row align-content-top">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <h2 id="environmental-impact" class="collapse-header"><a class="collapsed" data-toggle="collapse" href="#environmental-impact-section" role="button" aria-expanded="false" aria-controls="environmental-impact-section">@lang('events.environmental_impact')</a></h2>
