                      ...
                      <table class="table table-repair" role="table" id="device-table">
                          <thead>
                              <tr>
                                  ...
                                  <th class="d-none d-sm-none">Category</th>
                                  <th class="d-none d-sm-none">Brand</th>
                                  <th class="d-none d-sm-none">Model</th>
                                  <th class="d-none d-sm-none">Age</th>
                                  ...
                                  @if( Auth::check() )
                                    @if(FixometerHelper::hasRole(Auth::user(), 'Administrator') || FixometerHelper::userHasEditPartyPermission($formdata->id, Auth::user()->id) )
                                      <th width="35px" class="d-none d-sm-none"></th>
                                    @endif
                                  @endif
                              </tr>
                          </thead>
