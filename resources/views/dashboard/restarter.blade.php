@if ($user->number_of_logins <= 2)
    <div class="col-md-4 col-lg-3 col-dashboard">@include('dashboard.blocks.discussion')</div>
...
@else
    <div class="col-sm-6 col-md-5 col-lg-4 col-xl-3 col-dashboard">@include('dashboard.blocks.discussion')</div>
