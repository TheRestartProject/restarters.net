...
Check your [dashboard]({{ env('APP_URL') }}{{ \App\Providers\RouteServiceProvider::HOME }}) to see which events are coming up near you. Why not RSVP to one and come along? These are great chances to meet some fellow Restarters and find out how it all works.
