    ...
    <div class="container" id="public-dataviz-stats">
        ...
        <section class="row" id="impact-header">
            ...
            <div class="col-sm-12 text-center">
                ...
                <p class="big">
                    ...
                    <span class="big blue"><?php echo $pax; ?> participants</span> aided by <span class="big blue"><?php echo 0; //$hours; ?> hours of volunteered time</span> worked on <span class="big blue"><?php echo 0; //($device_count_status[0]->counter + $device_count_status[1]->counter + $device_count_status[2]->counter) ?> devices.</span>
        ...
        <section class="row" id="impact-devices">
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-xs-4 col-sm-4 col-md-4"><div class="topper  text-center"><?php echo 0;//$top[0]->name . ' [' . $top[0]->counter . ']'; ?></div></div>
                    <div class="col-xs-4 col-sm-4 col-md-4"><div class="topper  text-center"><?php echo 0;//$top[1]->name . ' [' . $top[1]->counter . ']'; ?></div></div>
                    <div class="col-xs-4 col-sm-4 col-md-4"><div class="topper  text-center"><?php echo 0;//$top[2]->name . ' [' . $top[2]->counter . ']'; ?></div></div>
                </div>
            </div>
            <?php if($paragraph_only == false ) { ?>
            </a>
                ...
                <div class="di_manufacture">
                    ...
                    <?php for($i = 1; $i<= 0;/*$manufacture_eql_to;*/ $i++){ ?>
                        <div class="col-xs-4 col-sm-4 col-md-3 text-center">
                            <img src="/assets/icons/<?php echo 0; //$manufacture_img; ?>" class="img-responsive">
                        </div>
                    <?php } ?>
                   </div>
                    <div class="row">
                        <div class="col-md-12 text-center clearfix">
                            <br /><br /><br />
                            <div class="legend">1 <img src="/assets/icons/<?php echo 0; //$manufacture_img; ?>"> = <?php echo $manufacture_legend; ?> <?php _t("(approximately)");?></div>
