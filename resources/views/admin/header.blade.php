<div class="container">
    <div class="row host-header">
        ...
        <div class="col-md-8">
            <span class="">Welcome, <strong><?php echo 0; //$user->name; ?></strong></span><br />

            <?php if ($showbadges) { ?>
                <span class="">There are <a class="label label-warning" href=""><?php echo 0; //$showbadges; ?></a> guesstimated devices.</span>
            <?php  } ?>
        </div>
