                                        ...
                                        <div class="form-control form-control__select">
                                            <select id="categories" name="categories[]" class="form-control select2-tags"
                                                ...
                                                <optgroup label="<?php echo $cluster->name; ?>">
                                                    ...
                                                    @if (!empty($selected_categories) && in_array($c->idcategories,
                                                    $selected_categories))
                    ...
                    <div class="col-12">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
                                        <label class="dropdown-item">
                                            <input class="filter-columns" data-id="deviceID" type="checkbox" value="1"
                                                class="dropdown-item-checkbox" checked> #</input>
                                        </label>
                                        <label class="dropdown-item">
                                            <input class="filter-columns" data-id="state" type="checkbox" value="1"
                                                class="dropdown-item-checkbox" checked> State</input>
                                        </label>
                                        <label class="dropdown-item">
                                            <input class="filter-columns" data-id="category" type="checkbox" value="1"
                                                class="dropdown-item-checkbox" checked> Category</input>
                                        </label>
                                        <label class="dropdown-item">
                                            <input class="filter-columns" data-id="brand" type="checkbox" value="1"
                                                class="dropdown-item-checkbox" checked> Brand</input>
                                        </label>
                                        <label class="dropdown-item">
                                            <input class="filter-columns" data-id="model" type="checkbox" value="1"
                                                class="dropdown-item-checkbox" checked> Model</input>
                                        </label>
                                        <label class="dropdown-item">
                                            <input class="filter-columns" data-id="comment" type="checkbox" value="1"
                                                class="dropdown-item-checkbox" checked> Comment</input>
                                        </label>
                                        <label class="dropdown-item">
                                            <input class="filter-columns" data-id="eventGroup" type="checkbox" value="1"
                                                class="dropdown-item-checkbox" checked> Event (Group)</input>
                                        </label>
                                        <label class="dropdown-item">
                                            <input class="filter-columns" data-id="eventDate" type="checkbox" value="1"
                                                class="dropdown-item-checkbox" checked> Event Date</input>
                                        </label>
                                        <label class="dropdown-item">
                                            <input class="filter-columns" data-id="location" type="checkbox" value="1"
                                                class="dropdown-item-checkbox" checked> Location</input>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="d-flex justify-content-center">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    @if (!empty($_GET))
                                    {!! $list->appends(['categories' => $selected_categories, 'groups' =>
                                    $selected_groups, 'from_date' => $from_date, 'to-date' => $to_date, 'device_id' =>
                                    $device_id, 'brand' => $brand, 'model' => $model, 'problem' => $problem, 'status'
                                    => $status])->links() !!}
                                    @else
                                    {!! $list->links() !!}
                                    @endif
