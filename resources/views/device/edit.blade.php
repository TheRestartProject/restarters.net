                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="repair_status" id="repair_status_2" value="2" <?php echo 0; //($formdata->repair_status == 2 ? ' checked' : ''); ?>> Repairable
                                                </label>
                                            </div>
                                            <div id="repairable-details">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" name="more_time_needed" id="more_time_needed" value="1" <?php echo 0; //($formdata->repair_status == 3 ? ' checked' : ''); ?>> More time needed
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" name="professional_help" id="professional_help" value="1"  <?php echo 0; //($formdata->professioanl_help == 1 ? ' checked' : ''); ?>> Professional help
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="repair_status" id="repair_status_3" value="3" <?php echo 0; //($formdata->end_of_lifecycle == 1 ? ' checked' : ''); ?>> End of lifecycle
                                                </label>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="spare_parts" id="spare_parts_1" value="1"  <?php echo 0; //($formdata->spare_parts == 1 ? ' checked' : ''); ?>> Yes
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="spare_parts" id="spare_parts_2" value="2"  <?php echo 0; //($formdata->spare_parts == 2 ? ' checked' : ''); ?>> No
                                            </label>
                                        </div>
                                    </div>
