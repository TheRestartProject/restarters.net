          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group form-group__offset">
                  ...
                  <input type="text" class="form-control field" id="name" name="name" value="{{ $formdata->name }}">
              </div>
              ...
              <!-- <div class="form-group">
                ...
                <noscript>
                  <textarea name="description" id="grp_about" value="{{ $formdata->free_text }}"></textarea>
                </noscript>
              </div> -->
              ...
              <div class="form-group">
                ...
                <div class="button-group row row-compressed-xs">
                    <div class="col-lg-12 d-flex align-items-center justify-content-end">
                        <button type="submit" class="btn btn-primary btn-create">Edit group</button>
                    </div>
                </div>
