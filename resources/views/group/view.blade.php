                ...
                <div class="table-responsive">
                    <table class="table table-events table-striped" role="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="#">Bank holiday restart @ The Old Chapel</a></td>
                            ...
                            <tr>
                                ...
                                <td class="cell-date">08/05/2018<br>13:00-18:30</td>
                                <td class="cell-locations">3Space, Bermondsey, London</td>
                                <td class="cell-progress" colspan="6">This event is in progress <a href="##devices">Add a device</a></td>
                            </tr>
                    ...
                    <table class="table table-events table-striped" role="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="cell-progress" colspan="4">No devices added <a href="##devices">Add a device</a></td>
                            </tr>
