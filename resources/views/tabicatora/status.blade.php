...
<meta name="keywords" content="TabiCat:ORA, TabiCat, smartphones, mobiles, handi iPhone, Samsung Galaxy, community events, Restart Parties, Repair Cafés, repair data, Right to Repair, Open Repair Alliance, The Restart Project, Open Repair Data, FixFest">
    ...
    <div class="container mt-1 mt-sm-4">
        <div class="row row-compressed">
            ...
            https://commons.wikimedia.org/wiki/Category:SVG_emoji_smilies
                ...
                @php( $back = '/tabicatora' . ($partner ? "?partner=$partner" : '') )
                <a href="{{ $back }}">
                    <img src="{{ asset('/images/tabicatora/099-smiling-cat-face-with-heart-eyes-64px.svg.png') }}" alt="Go to TabiCat:ORA" width="48" height="48" />
                </a>
            </div>
        </div>
