...
<section class="tabicat">
    <div class="container mt-1 mt-sm-4">
        <div class="row row-compressed">
            <div class="col-6">
                <h1 class="pull-left">TabiCat:ORA Status</h1>
            </div>
            ...
            https://commons.wikimedia.org/wiki/Category:SVG_emoji_smilies
                ...
                <a href="{{ '/tabicatora' . ($partner ? '?partner=$partner' : '') }}" class="pull-right">
                    <img id="tabicat" src="{{ asset('/images/tabicatora/099-smiling-cat-face-with-heart-eyes-64px.svg.png') }}" alt="Go to TabiCat:ORA" width="48" height="48" />
                </a>
            </div>
        </div>
