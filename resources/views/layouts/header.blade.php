                                ...
                                <li class="d-flex">
                                    <div class="badge-group">
                                        @if( is_null($total_talk_notifications) )
                                            <a href="{{{ env('DISCOURSE_URL') }}}/session/sso?return_path={{{ env('DISCOURSE_URL') }}}" class="badge bagde-talk-notifications  badge-pill badge-info badge-left badge-no-notifications">
                                        @else
                                            <a href="{{{ env('DISCOURSE_URL') }}}/session/sso?return_path={{{ env('DISCOURSE_URL') }}}/u/{{{ Auth::user()->username }}}/notifications" class="badge badge-talk-notifications badge-pill badge-info badge-left @if( $total_talk_notifications == 0 ) badge-no-notifications @endif">
                                        @endif
