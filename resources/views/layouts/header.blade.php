                                ...
                                <li class="d-flex">
                                    <div class="badge-group">
                                        @if( is_null($total_talk_notifications) )
                                            <a href="{{{ env('DISCOURSE_URL') }}}" target="_blank" class="badge badge-pill badge-info badge-left badge-no-notifications">
                                        @else
                                            <a href="{{{ env('DISCOURSE_URL') }}}/u/{{{ Auth::user()->username }}}/notifications" target="_blank" class="badge badge-pill badge-info badge-left @if( $total_talk_notifications == 0 ) badge-no-notifications @endif">
                                        @endif
                                            ...
                                            <span class="chat-count">{{{ $total_talk_notifications }}}</span>
                                            <span class="badge-lg-text">View talk</span>
                                        </a>
                                        <div>
