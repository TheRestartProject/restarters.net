...
<ul class="nav-right">
    ...
    @if (!$user )
      ...
      <li style="width:130px;"><a style="text-transform: initial; background: black; color: white; margin-bottom: 10px; width: 120px; height: 40px;" href="/about">@lang('login.join_title_short')</a></li>
    @else
      <li class="d-flex">
