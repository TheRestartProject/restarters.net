...
return [
  ...
  'created' => [
    ...
    'modified' => [
      ...
      'end' => '<strong>Event End Time</strong> set as "<strong>:new</strong>"',
      'venue' => '<strong>Event Name</strong> set as "<strong>:new</strong>"',
      'location' => '<strong>Event Location</strong> set as "<strong>:new</strong>"',
      'latitude' => '<strong>Event Latitude</strong> set as "<strong>:new</strong>"',
      'longitude' => '<strong>Event Longitude</strong> set as "<strong>:new</strong>"',
      'free_text' => '<strong>Free Text</strong> set as "<strong>:new</strong>"',
      'pax' => '<strong>pax</strong> set as "<strong>:new</strong>"',
  ...
  'updated' => [
    ...
    'modified' => [
      ...
      'end' => '<strong>Event End Time</strong> was modified from "<strong>:old</strong>" to "<strong>:new</strong>"',
      'venue' => '<strong>Event Name</strong> was modified from "<strong>:old</strong>" to "<strong>:new</strong>"',
      'location' => '<strong>Event Location</strong> was modified from "<strong>:old</strong>" to "<strong>:new</strong>"',
      'latitude' => '<strong>Event Latitude</strong> was modified from "<strong>:old</strong>" to "<strong>:new</strong>"',
      'longitude' => '<strong>Event Longitude</strong> was modified from "<strong>:old</strong>" to "<strong>:new</strong>"',
