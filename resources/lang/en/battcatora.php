...
return array(
    ...
    array(
        ...
        'question-repairable' => 'What is the next step to repair this device?',
        'step1' => 'Read the information about the broken device.',
        'step1-extra' => 'Someone brought this broken device to a community repair event.',
        'device' => 'Device',
        'brand' => 'Brand',
        'status' => 'Status',
        'problem' => 'Description of problem',
        'step2-extra' => 'Select the option that best fits the problem described above.',
        'fetch_another' => 'I don\'t know, show me another device',
        'translate' => 'Translate',
        'go_with' => 'Go with',
        'source' => 'Source',
