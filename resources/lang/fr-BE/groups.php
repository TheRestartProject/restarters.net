...
return [
  ...
  'search_groups' => 'Chercher tous les Repair Cafés',
  ...
  'groups_title3' => 'Tous les Repair Cafés',
  'groups_name' => 'Nom',
  ...
  'all_volunteers_group_name_message' => 'Voici une liste de tous les bénévoles de votre repair café et leurs compétences',
  ...
  'consider_starting_a_group' => 'Voulez-vous créer ou ajouter un Repair Café? Regardez dans <a href=":resources_url">nos ressources</a>.',
  'done_button' => 'Fait',
  ...
  'no_groups_near_you' => 'Nous ne trouvons aucun Repair Café dans notre base de données près de chez vous (:area)',
  ...
  'cars' => '{0}voitures|{1}voiture|[2,*]voitures',
  ...
  'group_events' => 'Evénements Repair Café',
  'host' => 'Organisateur',
  'hours_volunteered' => 'Heures de bénévolat',
  'invite_to_group' => 'Inviter au Repair Café',
  'invite_volunteers' => 'Inviter des bénévoles',
  'key_stats' => 'Statistiques',
  'like_manufacturing' => 'Equivalent à la fabrication de',
  'like_watching_tv' => 'Comme regarder la télévision pendant',
  ...
  'sofas' => '{0}divan|{1}divans|[2,*]divans',
  ...
  'not_counting' => 'L\'impact environnemental de ce groupe n\'est pas pris en compte',
  ...
  'computed_and_home_office' => 'Ordinateur et bureau',
  'create_groups_mobile2' => 'Ajouter nouveau',
  'electronic_gadget' => 'Gadget électronique',
  ...
  'home_entertainment' => 'Divertissement',
  'introduction' => 'Nous sommes un réseau d\'initiatives locales de réparation du monde entier',
  'join_group_button_mobile' => 'Suivre',
  'kitchen_and_household_items' => 'Appareils ménagers',
  ...
  'quick_access' => 'Les Repair Cafés que vous créez ou suivez apparaissent ci-dessous pour un accès rapide.',
  ...
  'database_error' => 'Le Repair Café <strong>n\'a pas pu</strong> être créé. Une erreur s\'est glissée dans la base de données.',
