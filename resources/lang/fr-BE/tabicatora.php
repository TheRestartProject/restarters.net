...
return array (
  ...
  array (
    ...
    'body-s1-p2' => 'Avec TabiCat, vous pouvez participer à notre enquête. Nous avons recueilli des informations sur plus de 800 imprimantes en panne et nous avons besoin de votre aide pour les classer.',
    'body-s2-header' => 'Que dois-je faire?',
    'body-s2-p1' => 'Il vous suffit de lire les informations relatives à l’imprimante en panne et de sélectionner le type de panne décrite dans la liste située en dessous. Si vous n’êtes pas sûr, sélectionnez simplement “Je ne sais pas” en bas de la liste. Une fois que vous aurez sélectionné une option, nous vous montrerons une autre imprimante. Plus vous pouvez classer de pannes d’imprimantes, plus nous apprenons ! TabiCat montre chaque imprimante à 3 personnes pour aider à confirmer la bonne catégorie.',
    'body-s3-header' => 'Où TabiCat obtient-il des données sur les imprimantes en panne?',
    'body-s3-p1' => 'TabiCat utilise les informations de <a href=":url" target="_blank">l’Open Repair Alliance</a>, qui recueille des données sur les appareils cassés que des personnes réelles du monde entier ont essayé de réparer lors d’événements communautaires, tels que les Repair Cafés et les Restart Parties.',
