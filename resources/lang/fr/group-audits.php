...
return [
  ...
  'created' => [
    ...
    'modified' => [
      ...
      'country' => '<strong>Country</strong> set as "<strong>:new</strong>"',
      'location' => '<strong>Location</strong> set as "<strong>:new</strong>"',
      'latitude' => '<strong>Latitude</strong> set as "<strong>:new</strong>"',
  ...
  'updated' => [
    ...
    'modified' => [
      ...
      'country' => '<strong>Country</strong> was modified from "<strong>:old</strong>" to "<strong>:new</strong>"',
      'location' => '<strong>Location</strong> was modified from "<strong>:old</strong>" to "<strong>:new</strong>"',
