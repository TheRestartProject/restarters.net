...
return [
  'cta' => [
    ...
    'printcat' => [
      ...
      'short_description' => '¡Ayúdenos a descubrir los problemas más comunes que nos encontramos en las impresoras!',
    ],
    'tabicat' => [
      ...
      'short_description' => '¿Por qué fallan las tabletas y cuáles son los obstáculos para repararlas?',
    ],
    'title' => '¡Colabora! MobiFix',
    'mobifixora' => [
      'get_involved' => 'Participa',
      'title' => '¡Colabora! MobiFix:ORA',
    ],
    'mobifix' => [
      'get_involved' => 'Participa',
      'title' => '¡Colabora! MobiFix',
    ...
    'battcat' => [
      'description' => '<p>En los eventos de reparación vemos muchos dispositivos rotos que tienen un problema de batería. Pero, ¿qué es lo que hace que las baterías fallen y qué podría facilitar su reparación o sustitución? Ayúdanos a descubrir los problemas más comunes que vemos en las baterías con BattCat! </p> <p>Los datos de reparación en BattCat provienen de todo el mundo, a través de los socios de la <a target="_blank" style="color:#212529;text-decoration:underline" href="https://openrepair.org">Alianza de Reparación Abierta</a>.',
      'get_involved' => 'Participa',
      'title' => '¡Colabora! BattCat',
    ],
  ],
  'discussion' => [
    'number_of_comments' => 'Número de comentarios',
    'see_all' => 'Ver todos',
    'title' => 'Lo que está sucediendo',
    'topic_created_at' => 'Tema creado',
  ],
  'news' => [
    'content' => 'A través de nuestra búsqueda MobiFix, voluntarios de todo el mundo nos ayudaron a analizar los datos de la Open Repair Alliance sobre los smartphones.
                    <ul>
                        <li><a href="https://openrepair.org/open-data/insights/mobiles" target="_blank" onclick="window.ga(\'send\', \'event\', \'microtasking\', \'news-click\', \'mobifix-openrepair-insights\')">Lee el análisis</a> utilizado para preparar el informe sobre la vida útil de los smartphones, ¡y descárgate los resultados tú mismo! </li>
                    </ul>',
    'title' => 'Conozca nuestros éxitos recientes',
  ],
