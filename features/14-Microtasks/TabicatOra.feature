Feature: Tabicat:ORA  
    ...
    I should be able to view the default Tabicat:ORA page.
    ...
    I should be able to view the Tabicat:ORA status page.
    I should be able to navigate to the Mobifix:ORA status page.
    I should be able to view the Tabicat:ORA info modal.
...
Scenario Outline: View default page with ORDS record
    When a user loads the Tabicat:ORA page (default)
...
Scenario Outline: View default page with filtered ORDS record
    When a user loads the Tabicat:ORA page (default) with partner query
    they are presented with an ORDS record with ORDS category "Mobile"
    and ORDS partner for <partner> only
    unless all such records have attained max opinions.

Scenario Outline: View status page
    When a user loads the Tabicat:ORA status page
...
Scenario Outline: View default page with no available ORDS records
    When a user loads the Tabicat:ORA page
...
Scenario Outline: Navigate to Tabicat:ORA status page from default page
    When a user clicks on <cat icon>
    then they land on the Tabicat:ORA status page.

Scenario Outline: Navigate to default page from status page
    When a user clicks on <cat icon>
    then they land on the Tabicat:ORA default page.
...
Scenario Outline: Navigate to info modal
    ...
    then they are presented with a modal containing content about Tabicat:ORA.
